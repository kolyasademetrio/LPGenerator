...
$count_col = $db->get_val('count_col', $tmpl_id, 3, 'html_content');// Количество блоков в сетке Bootstrap
...
create_array($tmpl_id, array(
                                'title',// если есть title - выводим классы для центрирования/прописные/строчные  - всё что относится к заголовку имеет в начале "title"
                                'section_name'
                            ),
